...
from src.config.llm_config import GENERATION_MODEL
...
class BuilderService:
    ...
    def generate_single(self, persona: str, api_key: str) -> GenerateResponse:
        self._generator.validate_persona(persona)
        payload, attempts = self._generator.generate(persona, api_key)
